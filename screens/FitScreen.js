...
const FitScreen = () => {
  ...
  return (
    <SafeAreaView style={{marginTop:32}} >
      <Image style={{height:370}} source={{uri:current.image}} />
      <Text style={{marginLeft:"auto", marginRight:"auto", marginTop:30, fontSize:30, fontWeight:"bold"}} >{current.name}</Text>
      <Text style={{marginLeft:"auto", marginRight:"auto", marginTop:33, fontSize:38, fontWeight:"bold"}} >X{current.sets}</Text>
     ...
     setTimeout(() => {
      ...
      <Pressable style={{flexDirection:"row", alignItems:"center", marginLeft:"auto", marginRight:"auto", marginTop:50}} >
        ...
        style={{width:100, backgroundColor:"green", padding:10, borderRadius:20, marginHorizontal:20}}>
