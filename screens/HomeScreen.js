...
const HomeScreen = () => {
    const {completed,  minutes,  calories,  workout, } = useContext(FitnessItems);
    return (
        <ScrollView style={{marginTop:30}}>
            
                
                <View style={{ backgroundColor: "#cd853f", padding: 10,  height:200}} >
                    ...
                    <View style={{ justifyContent: "center", alignItems: "center" }} >
                        <Image style={{ width: 330, height: 120, margin: 20 , borderRadius: 7, }} source={{ uri: "https://cdn-images.cure.fit/www-curefit-com/image/upload/c_fill,w_842,ar_1.2,q_auto:eco,dpr_2,f_auto,fl_progressive/image/test/sku-card-widget/gold2.png" }} />
                    </View>
